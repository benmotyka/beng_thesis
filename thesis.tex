...
\abstract{W skład pracy wchodzi utworzenie interaktywnego systemu e-learningowego o zagrożeniach w obszarze cyberbezpieczeństwa z elementami wirtualnej rzeczywistości oraz dokumentacja wybranych zagrożeń. Pierwszy rozdział przedstawia cel i zakres pracy. W drugim rozdziale przedstawiony jest dokładny opis technologii. System składa się on ze strony internetowej wykonanej w technologii React.js, aplikacji działającej po stronie serwera wykonanej w technologii Node.js oraz nierelacyjnej bazy danych MongoDB. Strona internetowa pozwala na interaktywny udział w kursach związanych z tematyką pracy wraz z weryfikacją efektów kształcenia. W trzecim rozdziale przedstawiona jest dokumentacja i implementacja wybranych zagrożeń wraz z potencjalnymi metodami ochrony, a także dalsze plany na rozwój projektu.}
\abstractEN{The work presents the creation of an interactive e-learning system on cyber security dangers with virtual reality elements and the documentation of selected threats. The first chapter introduces the purpose and scope of the work. The second chapter presents a detailed description of the technologies. The system consists of a website created in React.js, a server-side application created in Node.js and a non-relational MongoDB database. The website allows participating interactive courses related to the topic of the work along with verification of the learning effects. The third chapter presents the documentation and implementation of selected threats along with potential protection methods, as well as further plans for the development of the project.}
...
\item przygotowanie treści szkoleniowych w dwóch językach z elementami interakcji i wirtualnej rzeczywistości,
